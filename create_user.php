    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        <?php if(isset($_SESSION['no_email'])):?>
            <div class="alert alert-danger text-dark" role="alert">
                <strong>Уведомление!</strong> <?=display_flash_message('no_email')?>
            </div>
        <?php endif ?>
        <?php if(isset($_SESSION['not_ok'])):?>
            <div class="alert alert-danger text-dark" role="alert">
        ...
        <form method="post" action="app/create.php" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" name="phonanumber" class="form-control">
                                </div>
